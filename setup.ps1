...
Write-Host ""
Read-Host "Enter 키를 누르면 설치를 시작합니다"
...
if (Get-Command node -ErrorAction SilentlyContinue) {
    Write-Host "      이미 설치되어 있습니다. $(node -v)"
} else {
...
if (Get-Command git -ErrorAction SilentlyContinue) {
    Write-Host "      이미 설치되어 있습니다. $(git --version)"
} else {
...
if (Get-Command qpdf -ErrorAction SilentlyContinue) {
    Write-Host "      이미 설치되어 있습니다. $(qpdf --version)"
} else {
...
Write-Host ""
Read-Host "Enter 키를 누르면 Extension을 실행합니다"
